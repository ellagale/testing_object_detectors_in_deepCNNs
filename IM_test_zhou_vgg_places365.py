...
r.deploy_file = os.path.join(dir_root,'zoo/vgg16_places365.prototxt')
...
h5_files_directory = os.path.join('/storage/data/Unmerged','VggPlaces365')
r.do_limited = True
...
neuron=405
current_neuron_index = neuron-1
do_bus = False
do_car = True
figure_out_name = 'VggPlaces365Lconv5u' + str(neuron)
...
ICLRPaperTest(classAindices=car_indices,
                  current_neuron_index=current_neuron_index,
                  x_data=x_data,
                  acts=acts,

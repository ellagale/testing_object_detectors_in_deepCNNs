...
from h5_analysis_jitterer import class_code_to_name, make_class_to_line_number_look_up_table, build_label_dict, \
    fs_plotter, find_gaps_between_clusters, class_lineno_to_name
...
r.labels_file = os.path.join('/storage/data/ilsvrc12/synset_words.txt', 'synset_words.txt') # file with the class labels in it  should be ''class code' 'name'\n'
...
h5_files_directory = os.path.join(dir_root)
r.do_limited = True
...
jitterer(x_data=cluster_list, colour_flag='cluster', title='Yo',
                                     ...
                                     x_range=[-5, 150], y_range=None, label_dict=label_dict,
                                     outLayerNeuron=True,
